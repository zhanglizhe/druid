...
import io.druid.query.extraction.ExplicitDimRenameFn;
        ...
        .setDimensions(
            Lists.<DimensionSpec>newArrayList(
                new ExtractionDimensionSpec(
                    "quality", "alias", new ExplicitDimRenameFn(map, false, null, false), null
                )
            )
        )
        .setAggregatorSpecs(
  ...
  public void testGroupByWithSimpleRename()
  {
    ...
    GroupByQuery query = GroupByQuery
        ...
        .setDimensions(
            Lists.<DimensionSpec>newArrayList(
                new ExtractionDimensionSpec(
                    "quality", "alias", new ExplicitDimRenameFn(map, false, null, true), null
                )
            )
        )
        .setAggregatorSpecs(
