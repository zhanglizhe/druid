...
public abstract class FunctionalExtraction extends DimExtractionFn
{
  ...
  )
  {
    ...
    this.replaceMissingValueWith = Strings.isNullOrEmpty(replaceMissingValueWith) ? null : replaceMissingValueWith;
  ...
  public boolean isRetainMissingValue() {return retainMissingValue;}

  public String getReplaceMissingValueWith() {return replaceMissingValueWith;}
