...
public abstract class ObjectStrategy<T> implements Comparator<T>
{
   ...
   */
  public abstract T fromByteBuffer(ByteBuffer buffer, int numBytes);
  public abstract byte[] toBytes(T val);

  public void writeTo(T val, OutputBytes out) throws IOException
  {
