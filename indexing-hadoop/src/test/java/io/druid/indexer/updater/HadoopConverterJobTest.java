...
import io.druid.metadata.TestDerbyDB;
...
public class HadoopConverterJobTest
{
  ...
  @Rule
  public final TestDerbyDB testDerbyDB = new TestDerbyDB();
  ...
  private final MetadataStorageUpdaterJobSpec metadataStorageUpdaterJobSpc = new MetadataStorageUpdaterJobSpec()
  {
    ...
    {
      return testDerbyDB.getConnectionString();
    }
    ...
    {
      return testDerbyDB.getConnectorConfig();
    }
  };
  ...
  public void setUp() throws Exception
  {
    ...
    connector = testDerbyDB.getConnector(metadataStorageTablesConfigSupplier);
