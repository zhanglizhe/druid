...
public class CostBalancerStrategy implements BalancerStrategy
{
  ...
  static final double COST_FACTOR = 1 / (LAMBDA * LAMBDA);
  static final double MILLIS_FACTOR = MILLIS_IN_HOUR / LAMBDA;
  ...
  public static double computeJointSegmentsCost(final DataSegment segmentA, final DataSegment segmentB)
  {
    ...
    return COST_FACTOR * intervalCost(t1, start, end) * multiplier;
  }
