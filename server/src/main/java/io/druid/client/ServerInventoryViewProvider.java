...
@JsonSubTypes(value = {
    ...
    @JsonSubTypes.Type(name = "twoZk", value = TwoZkServerInventoryViewProvider.class)
})
public interface ServerInventoryViewProvider extends Provider<AbstractServerInventoryView>
{
}
