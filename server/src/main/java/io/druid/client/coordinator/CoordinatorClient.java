...
public class CoordinatorClient
{
  ...
  public List<SegmentLoadInfo> fetchServerView(String dataSource, Interval interval, boolean incompleteOk)
  {
    try {
          ...
          new Request(
              ...
              new URL(
                  String.format(
                      ...
                      baseUrl(),
                      dataSource,
                      URLEncoder.encode(interval.toString(), "UTF-8"),
                      incompleteOk
                  )
              )
          ),
      ...
      return jsonMapper.readValue(
          response.getContent(), new TypeReference<List<SegmentLoadInfo>>()
          {
