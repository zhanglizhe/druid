...
public class CoordinatorServerView implements InventoryView
{
  ...
  private final Map<String, Set<DruidServerMetadata>> servers;
  ...
  private void serverAddedSegment(final DruidServerMetadata server, final DataSegment segment)
  {
    ...
    synchronized (lock) {
      ...
      Set<DruidServerMetadata> servers = this.servers.get(segmentId);
      if (servers == null) {
        ...
        this.servers.put(segmentId, servers);
      }
      servers.add(server);
    }
  }
  ...
  private void serverRemovedSegment(DruidServerMetadata server, DataSegment segment)
  {
    ...
    synchronized (lock) {
      ...
      servers = this.servers.get(segmentId);
      if (servers == null) {
